...
COMMENT ON COLUMN tbl_reply.replayer IS
    '댓글작성자ID';
...
COMMENT ON COLUMN tbl_reply.board_bno IS
    '게시물관리고유값 외래키';

ALTER TABLE tbl_reply ADD CONSTRAINT tbl_reply_pk PRIMARY KEY ( rno );
ALTER TABLE tbl_attach
    ADD CONSTRAINT tbl_attach_tbl_board_fk FOREIGN KEY ( board_bno )
...
ALTER TABLE tbl_reply
    ADD CONSTRAINT tbl_reply_tbl_board_fk FOREIGN KEY ( board_bno )
        REFERENCES tbl_board ( bno )
    NOT DEFERRABLE;
