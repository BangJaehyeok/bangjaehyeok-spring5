...
public class CommonUtil {
	...
	public void profile_upload(String user_id, HttpServletRequest request, 
			MultipartFile file) throws IOException {
		// 프로필이미지는 보안이 필요한 폴더가 아닌, resources폴더에 업로드 처리. 서버의 경로 필요
		...
		//폴더1개에 파일이 1000개 이상이면, 서버의 조회속도가 현저히 느려진다.
		//년월일 폴더를 생성후 업로드된 파일을 년월일 폴더로 관리한다.
