  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card">
          ...
          <div class="card-body p-0">
            ...
            <c:forEach var="memberVO" items="${latestMembers}">
	               ...
	               <!-- <img src="" alt="User Image"> 아래 onerror는 엑박일때 대신 보여줄 이미지를 지정-->
	               <img style="width:120px;height:120px;" onerror="this.src='/resources/admin/dist/img/default-150x150.png'" 
	               		src="/resources/profile/${memberVO.user_id}.png">
		...
		<!-- include와 import의 차이점: include는 소스를 조립 후 컴파일, 
			import는 개별파일을 컴파일 후 조립 -->
