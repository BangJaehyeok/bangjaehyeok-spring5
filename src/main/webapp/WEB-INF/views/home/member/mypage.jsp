			...
			<fieldset>
				...
				<ul class="app_list">
					<li class="clear">
						...
						<div class="app_content"><input value="${memberVO.user_id}" readonly type="text" name="user_id" class="w100p" id="user_id_lbl" required/></div>
					</li>
					<li class="clear">
					...
					<li class="clear">
						<label for="eamil_lbl" class="tit_lbl pilsoo_item">이메일</label>
					...
					<li class="clear">
						...
						<div class="app_content"><input value="${memberVO.point}" readonly type="digits" name="point" class="w100p" id="point_lbl" required/></div>
					</li>
					<li class="clear">
